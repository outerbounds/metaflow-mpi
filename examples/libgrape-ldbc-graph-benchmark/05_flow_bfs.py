    ...
    def multinode(self):
        ...
        current.mpi.exec(
            ...
            program_args=[
                ...
                "--application", "bfs",                  # Application - computes the minimum number of hops required to reach v from a given source vertex
                "--bfs_source", self.bfs_source,                
                "--out_prefix", "./output_bfs"
            ]
        )
