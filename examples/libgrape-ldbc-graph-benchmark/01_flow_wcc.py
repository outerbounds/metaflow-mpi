...
class WeaklyConnectedComponent(FlowSpec):
    ...
    def multinode(self):
        ...
        current.mpi.exec(
            ...
            program_args=[
                "--application", "wcc",                  # Application - computes the weakly connected component each vertex belongs to
                "--vfile", "%s/p2p-31.v" % dataset_path, # Vertex data
                "--efile", "%s/p2p-31.e" % dataset_path, # Edge data
                "--out_prefix", "./output_wcc"
            ]
        )
