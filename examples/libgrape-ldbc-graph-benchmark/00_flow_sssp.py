    ...
    def multinode(self):
        ...
        current.mpi.exec(
            ...
            program_args=[
                ...
                "--application", "sssp",                 # Application - computes the length of the shortest paths from a given source vertex to all other vertices in graphs
                "--sssp_source", self.sssp_source,                
                "--out_prefix", "./output_sssp",
                "--directed"
            ]
        )
